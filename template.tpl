...

{
  ...
  "securityGroups": [],
  "displayName": "Dutch Zipcode (Postcode) to State (Provincie)",
  "description": "Based on the first 4 digits of a dutch zipcode the state or province in the Netherlands will be returned.",
  "containerContexts": [
    "SERVER"
  ]
}
...
if(zipcode !== undefined)
{
  ...
  //Convert digits into string for comparison
...
Based on this list https://nl.wikipedia.org/wiki/Postcodes_in_Nederland
